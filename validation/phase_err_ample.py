...
resultFile = open("ample_phaseerr_table_pdb.csv",'wb')
resultFile_best = open("ample_phaseerr_table_best_pdb.csv",'wb')
...
for pdb_id in pdb_unique_ids:
    ...
    result_path = pdb_id+"/phase_err_ample"
    phaser_res_path = pdb_id+"/phaser_ample"
    ...
    for cluster_dir in cluster_dirs:
        ...
        file_phaser = os.path.join("../phaser_ample/",cluster_dir,phaser_res_pdb)
        phaseerr_val = '90'
